...
<!-- ALT:> Simple decision flowchart showing Developer/BA choosing among 4 Azure hosting options -->

<!-- DESC: Simple decision flowchart showing Developer/BA choosing among 4 Azure hosting options: Azure App Service for simple deployment, Azure Kubernetes Service AKS for complex apps, Azure Spring Apps for Spring projects, and Virtual Machines for legacy lift-and-shift. -->  
