...
Dynamic view of an object interacting with SF foundation services.
...
A representation of an `Order`’s lifecycle as managed by SanFrancisco's object framework.
