...
Below is a high-level architecture of FHIR:
...
Now that you understand the architecture, let's zoom into the actual FHIR resources that flow through these pipes.

→ [Key FHIR Resources](deepdive-overview-fhir-resources.md)

---

## Further Reading

- [SMART App Launch Framework](https://hl7.org/fhir/smart-app-launch/) - Official HL7 specification
- [OAuth 2.0 for Native Apps (RFC 8252)](https://tools.ietf.org/html/rfc8252) - Mobile app security guidance
- [FHIR Security Documentation](https://www.hl7.org/fhir/security.html) - Threat models and mitigations
