...
SMART-on-FHIR stands on two complementary standards, **FHIR** and **SMART**.
...
2. **Authorization**: The app uses OAuth 2.0 to request access to the patient's observations and conditions. <br>The EHR prompts: "Allow CardioRisk to read vitals and lab results?"
